 ...
 * Pure JavaScript client-side QR Code generation
 */
var QRCode;
(function () {
	...
	QRCode.prototype._createCanvas = function () {
		...
		this._oCanvas.width = this._htOption.width;
		this._oCanvas.height = this._htOption.height;
		this._el.appendChild(this._oCanvas);
		this._oContext = this._oCanvas.getContext("2d");
	};

	QRCode.prototype.makeCode = function (sText) {
		var typeNum = this._htOption.typeNumber;
		if (sText.length > 50) typeNum = 6;
		if (sText.length > 100) typeNum = 10;
		var oQRCode = new QRCodeModel(typeNum, this._htOption.correctLevel);
		oQRCode.addData(sText);
		oQRCode.make();

		var ctx = this._oContext;
		var count = oQRCode.getModuleCount();
		var tileW = this._htOption.width / count;
		var tileH = this._htOption.height / count;

		ctx.clearRect(0, 0, this._htOption.width, this._htOption.height);
